...
export default function AdminError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto flex flex-col items-center justify-center min-h-[40vh] gap-4 text-center">
      <div className="text-4xl">⚠️</div>
      <h2 className="text-xl font-semibold text-verde-profundo">
        Algo salió mal
      </h2>
      <p className="text-sm text-marron-tierra max-w-sm">
        No pudimos cargar el dashboard. Puede ser un problema temporal con la
        base de datos.
      </p>
      {error.digest && (
